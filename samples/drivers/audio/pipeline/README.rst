...
This sample builds a small audio pipeline on top of the :ref:`libMP <mp_api>`
(Media Pipe) subsystem. Audio is captured from a digital microphone (DMIC),
...
On :ref:`native_sim <native_sim>` the audio drivers are file-backed, so the
...
* The pipeline captures :kconfig:option:`CONFIG_AUDIO_PIPELINE_NUM_FRAMES`
